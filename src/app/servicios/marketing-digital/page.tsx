    ...
    <>
      ...
      <main>
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          {/* Service Icon */}
          <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 rounded-3xl flex items-center justify-center shadow-2xl animate-hero-float">
